...
const Card = ({ card, index }) => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-10 opacity-100 md:opacity-0 transition-opacity duration-700 ease-in-out md:group-hover:opacity-100 bg-white/5 backdrop-blur-[2px] border-[1px] border-white/10 m-3 md:m-4 rounded-2xl" />

            {/* Content */}
            <div className="absolute inset-0 z-20 flex flex-col justify-between p-5 md:p-8 transition-transform duration-700 ease-[0.25,0.1,0.25,1.0] md:group-hover:-translate-y-2">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className={`opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700 delay-100 bg-white text-black rounded-full p-2 ${isPenthouse ? 'bg-travel-gold text-black' : ''}`}>
                ...
                {/* Bottom: Info */}
                <div className="translate-y-0 md:translate-y-4 transition-transform duration-700 ease-[0.25,0.1,0.25,1.0] md:group-hover:translate-y-0">
                    ...
                    <div className="h-auto opacity-100 overflow-hidden md:h-0 md:opacity-0 md:group-hover:h-auto md:group-hover:opacity-100 transition-all duration-700 ease-in-out">
...
export default function BentoGrid() {
    return (
        <section className="px-4 py-14 pb-28 md:py-20 md:pb-60 max-w-[1920px] mx-auto bg-[#0c0c0c]">
            <div className="mb-9 md:mb-20 px-1 md:px-12">
                <h2 className="font-serif text-3xl md:text-6xl text-white mb-4">
