...
import aiItinerary from '../serverless-handlers/ai-itinerary.js';
import visaRequirements from '../serverless-handlers/visa-requirements.js';
import gastronomy from '../serverless-handlers/gastronomy.js';

// Luxury & Intelligence APIs
import jetCharter from '../serverless-handlers/jet-charter.js';
import villas from '../serverless-handlers/villas.js';
import carbonOffset from '../serverless-handlers/carbon-offset.js';
import auroraForecast from '../serverless-handlers/aurora-forecast.js';
import tippingEtiquette from '../serverless-handlers/tipping-etiquette.js';
import emergencyServices from '../serverless-handlers/emergency-services.js';
import curatedOffers from '../serverless-handlers/curated-offers.js';

// Additional 100% Free Travel Intelligence APIs
import beachWaterQuality from '../serverless-handlers/beach-water-quality.js';
import currencyArbitrage from '../serverless-handlers/currency-arbitrage.js';
import astronomyStargazing from '../serverless-handlers/astronomy-stargazing.js';
import timezoneClocks from '../serverless-handlers/timezone-clocks.js';
import michelinDining from '../serverless-handlers/michelin-dining.js';
import wineVintage from '../serverless-handlers/wine-vintage.js';
import yachtCharter from '../serverless-handlers/yacht-charter.js';
import travelHealthVaccines from '../serverless-handlers/travel-health-vaccines.js';
...
export const routes = [
  ...
  { method: 'GET', path: '/api/ai-itinerary', handler: aiItinerary },
  { method: 'GET', path: '/api/visa-requirements', handler: visaRequirements },
  { method: 'GET', path: '/api/gastronomy', handler: gastronomy },
  ...
  // LUXURY & TRAVEL INTELLIGENCE APIS (100% Free & Zero Key)
  { method: 'GET', path: '/api/jet-charter', handler: jetCharter },
  { method: 'GET', path: '/api/villas', handler: villas },
  { method: 'GET', path: '/api/carbon-offset', handler: carbonOffset },
  { method: 'GET', path: '/api/aurora-forecast', handler: auroraForecast },
  { method: 'GET', path: '/api/tipping-etiquette', handler: tippingEtiquette },
  { method: 'GET', path: '/api/emergency-services', handler: emergencyServices },
  { method: 'GET', path: '/api/curated-offers', handler: curatedOffers },
  { method: 'GET', path: '/api/beach-water-quality', handler: beachWaterQuality },
  { method: 'GET', path: '/api/currency-arbitrage', handler: currencyArbitrage },
  { method: 'GET', path: '/api/astronomy-stargazing', handler: astronomyStargazing },
  { method: 'GET', path: '/api/timezone-clocks', handler: timezoneClocks },
  { method: 'GET', path: '/api/michelin-dining', handler: michelinDining },
  { method: 'GET', path: '/api/wine-vintage', handler: wineVintage },
  { method: 'GET', path: '/api/yacht-charter', handler: yachtCharter },
  { method: 'GET', path: '/api/travel-health-vaccines', handler: travelHealthVaccines }
];
